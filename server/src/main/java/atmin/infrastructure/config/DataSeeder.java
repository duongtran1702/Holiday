...
public class DataSeeder implements CommandLineRunner {
    ...
    private final atmin.repository.PermissionRepository permissionRepository;
    private final atmin.repository.ProductRepository productRepository;
    ...
    private void seedProducts() {
        ...
        log.info("Khởi tạo danh sách Sản phẩm mẫu...");

        java.util.List<atmin.entity.Product> products = java.util.List.of(
            atmin.entity.Product.builder()
                .name("Áo Polo ABC Classic")
                .category("Áo")
                .price(280000.0)
                ...
                .badge("Bán chạy")
                .stock(java.util.Map.of("S-Trắng", 15, "M-Trắng", 22, "L-Trắng", 18, "XL-Trắng", 10, "XXL-Trắng", 5))
                .build(),
    ...
    private void seedPermissionsAndRoles() {
        ...
        Set<atmin.entity.Permission> allPerms = new java.util.HashSet<>();
        for (String permName : permissions) {
            atmin.entity.Permission p = permissionRepository.findByNameAndDeletedAtIsNull(permName)
                    .orElseGet(() -> {
                        log.info("Tạo Permission: " + permName);
                        return permissionRepository.save(atmin.entity.Permission.builder()
                                .name(permName)
