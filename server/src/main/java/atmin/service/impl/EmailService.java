...
public class EmailService implements IEmailService {
    ...
    public void sendResetPasswordEmail(String toEmail, String token) {
        ...
        try {
            ...
            log.error("Lỗi xác thực Email Server: {}", e.getMessage());
    ...
    public void sendNewStaffEmail(String toEmail, String fullName, String rawPassword) {
        ...
        try {
            ...
            // Khác với OTP hay Forgot Pass (là thao tác do người dùng chủ động yêu cầu trên Web),
            // Việc tạo tài khoản là do Admin thực hiện. Nếu lỗi gửi mail thì vẫn cho phép tạo thành công trong DB, 
            // Admin có thể báo IT cấp lại mật khẩu. Do đó chỉ ghi log lỗi chứ không ném Exception.
        }
    }
}
