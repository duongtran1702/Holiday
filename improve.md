...
vn.payos.exception.APIException: Cổng thanh toán không tồn tại hoặc đã tạm dừng, vui lòng chọn cổng khác
	at vn.payos.exception.APIException.fromResponse(APIException.java:117) ~[payos-java-2.0.1.jar:2.0.1]
	at vn.payos.core.Client.processResponse(Client.java:471) ~[payos-java-2.0.1.jar:2.0.1]
	at vn.payos.PayOS.execute(PayOS.java:295) ~[payos-java-2.0.1.jar:2.0.1]
	at vn.payos.PayOS.request(PayOS.java:91) ~[payos-java-2.0.1.jar:2.0.1]
	at vn.payos.PayOS.post(PayOS.java:137) ~[payos-java-2.0.1.jar:2.0.1]
	at vn.payos.service.blocking.v2.paymentRequests.PaymentRequestsServiceImpl.create(PaymentRequestsServiceImpl.java:48) ~[payos-java-2.0.1.jar:2.0.1]
	at vn.payos.service.blocking.v2.paymentRequests.PaymentRequestsServiceImpl.create(PaymentRequestsServiceImpl.java:53) ~[payos-java-2.0.1.jar:2.0.1]
	at atmin.service.impl.PaymentServiceImpl.createPaymentLink(PaymentServiceImpl.java:43) ~[main/:na]
	...
	at atmin.service.impl.PaymentServiceImpl

$$
SpringCGLIB
$$

0.createPaymentLinknav

) ~[main/:na]
	at atmin.service.impl.OrderServiceImpl.createOrder(OrderServiceImpl.java:99) ~[main/:na]
	at java.base/jdk.internal.reflect.DirectMethodHandleAccessor.invoke(DirectMethodHandleAccessor.java:103) ~[na:nav]
	at java.base/java.lang.reflect.Method.invoke(Method.java:580) ~[na:na]
	at org.springframework.aop.support.AopUtils.invokeJoinpointUsingReflection(AopUtils.java:359) ~[spring-aop-7.0.8.jar:7.0.8]
	...
	at atmin.service.impl.OrderServiceImpl

$$
SpringCGLIB
$$

0.createOrder(<generated></generated>) ~[main/:na]
	at atmin.controller.order.OrderController.createOrder(OrderController.java:29) ~[main/:na]
	at java.base/jdk.internal.reflect.DirectMethodHandleAccessor.invoke(DirectMethodHandleAccessor.java:103) ~[na:na]
	at java.base/java.lang.reflect.Method.invoke(Method.java:580) ~[na:na]
	...
	at org.springframework.security.web.FilterChainProxy$VirtualFilterChain.doFilter(FilterChainProxy.java:385) ~[spring-security-web-7.1.0.jar:7.1.0]
	at atmin.infrastructure.security.jwt.JwtAuthenticationFilter.doFilterInternal(JwtAuthenticationFilter.java:106) ~[main/:na]
	at org.springframework.web.filter.OncePerRequestFilter.doFilter(OncePerRequestFilter.java:116) ~[spring-web-7.0.8.jar:7.0.8]
	at org.springframework.security.web.FilterChainProxy$VirtualFilterChain.doFilter(FilterChainProxy.java:385) ~[spring-security-web-7.1.0.jar:7.1.0]
	at atmin.infrastructure.security.MdcLoggingFilter.doFilterInternal(MdcLoggingFilter.java:34) ~[main/:na]
	at org.springframework.web.filter.OncePerRequestFilter.doFilter(OncePerRequestFilter.java:116) ~[spring-web-7.0.8.jar:7.0.8]
	at org.springframework.security.web.FilterChainProxy$VirtualFilterChain.doFilter(FilterChainProxy.java:385) ~[spring-security-web-7.1.0.jar:7.1.0]
...
2026-07-15T05:47:38.290+07:00 ERROR 30940 --- [server] [nio-8080-exec-4] a.c.e.handler.CoreExceptionHandler       : TraceId=e231d2d6 | An unexpected error occurred at URI: /api/v1/orders

java.lang.RuntimeException: Không thể tạo link thanh toán: Cổng thanh toán không tồn tại hoặc đã tạm dừng, vui lòng chọn cổng khác
	at atmin.service.impl.PaymentServiceImpl.createPaymentLink(PaymentServiceImpl.java:47) ~[main/:na]
	at java.base/jdk.internal.reflect.DirectMethodHandleAccessor.invoke(DirectMethodHandleAccessor.java:103) ~[na:na]
	at java.base/java.lang.reflect.Method.invoke(Method.java:580) ~[na:na]
	at org.springframework.aop.support.AopUtils.invokeJoinpointUsingReflection(AopUtils.java:359) ~[spring-aop-7.0.8.jar:7.0.8]
	at org.springframework.aop.framework.CglibAopProxy$DynamicAdvisedInterceptor.intercept(CglibAopProxy.java:715) ~[spring-aop-7.0.8.jar:7.0.8]
...
0.createPaymentLink(<generated></generated>) ~[main/:na]
	at atmin.service.impl.OrderServiceImpl.createOrder(OrderServiceImpl.java:99) ~[main/:na]
	at java.base/jdk.internal.reflect.DirectMethodHandleAccessor.invoke(DirectMethodHandleAccessor.java:103) ~[na:na]
	at java.base/java.lang.reflect.Method.invoke(Method.java:580) ~[na:na]
	at org.springframework.aop.support.AopUtils.invokeJoinpointUsingReflection(AopUtils.java:359) ~[spring-aop-7.0.8.jar:7.0.8]
...
2026-07-15T05:47:38.297+07:00  WARN 30940 --- [server] [nio-8080-exec-4] .m.m.a.ExceptionHandlerExceptionResolver : Resolved [java.lang.RuntimeException: Không thể tạo link thanh toán: Cổng thanh toán không tồn tại hoặc đã tạm dừng, vui lòng chọn cổng khác]
